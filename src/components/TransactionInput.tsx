...
import { Loader2, Plus, Search, Package, MapPin, Calendar, FileText, Hash, ArrowDownRight, ArrowUpRight, CheckCircle2, ArrowRightLeft, FileDigit, Trash2 } from 'lucide-react';
          ...
          <form onSubmit={handleFormSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <select 
                    ...
                    onChange={e => {
                      ...
                      setFormTipe(val);
                      // Clear itemsList since changing the type changes locator configurations
                      setItemsList([]);
                    }}
            ...
            <div className="bg-white p-4 rounded-xl border border-slate-200 space-y-4 shadow-sm">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-4 items-end">
                  ...
                  <div className="relative">
                    <input 
                      ...
                      onChange={e => {
                        ...
                        // If they cleared, reset selection
                        if (!e.target.value) {
                          setSelectedProductIndex('');
                          setFormNamaBahan('');
                          setFormKodeProduk('');
                ...
                {/* Button to Append to Buffer List */}
